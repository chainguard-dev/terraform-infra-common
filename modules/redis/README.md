...
| <a name="input_authorized_client_service_accounts"></a> [authorized\_client\_service](#input\_authorized\_client\_service\_accounts) | List of service account emails that should be granted Redis viewer (read-only) access | `list(string)` | `[]` | no |

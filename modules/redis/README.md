...
|------|-------------|------|---------|:--------:|
| <a name="input_alternative_location_id"></a> location\_id](#input\_alternative\_location\_id) | The alternative zone where the instance will failover when zone is unavailable. | `string` | `""` | no |

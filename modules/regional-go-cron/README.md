...
| <a name="input_repository"></a> [repository](#input\_repository) | Container repository to publish images to. If empty, defaults to gcr.io/{project\_id}/{name}. | `string` | `""` | no |

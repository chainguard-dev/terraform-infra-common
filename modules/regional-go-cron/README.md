...
| <a name="input_otel_collector_image"></a> [otel\_collector\_image](#input\_otel\_collector\_image) | n/a | `string` | `"chainguard/opentelemetry-collector-contrib:latest"` | no |

...
| <a name="input_extra_sections"></a> [extra\_sections](#input\_extra\_sections) | Extra dashboard sections (outputs of dashboard/sections/* modules) added to the dashboard layout | `list(any)` | `[]` | no |

...
- Queued-work lower bound is exact when capacity is available and bounded while full
...
| <a name="module_work-queued-lower-bound"></a> [work-queued-lower-bound](#module\_work-queued-lower-bound) | ../../widgets/xy | n/a |

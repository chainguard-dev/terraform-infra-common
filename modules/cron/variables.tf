...
variable "base_image" {
  type        = string
  default     = "cgr.dev/chainguard/static:latest-glibc@sha256:24dd7ff8788fdfadda39eeeaefefb6d1cec6002a545935a5f7e017484053734f"
...
variable "resource_manager_tags" {
  description = "Forwarded to regional-go-cron. Resource Manager tags to bind to the job, as tagKeys/<id> => tagValues/<id>."
  type        = map(string)
  default     = {}
  nullable    = false

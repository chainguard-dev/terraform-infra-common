...
moved {
  from = google_project_iam_member.authorize-list
  to   = module.impl.google_project_iam_member.authorize-list
}
moved {
  from = null_resource.validate_success_alert_horizon
  to   = module.impl.null_resource.validate_success_alert_horizon
}
moved {
  from = google_monitoring_alert_policy.success
  to   = module.impl.google_monitoring_alert_policy.success
}

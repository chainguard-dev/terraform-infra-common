...
locals {
  ...
  // v0.142.0 or later, and older collectors reject unknown keys at startup,
  // so when scraping is disabled the keys are omitted from the rendered
  // config entirely rather than set to false.

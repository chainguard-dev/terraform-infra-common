...
| <a name="input_dead-letter-policy"></a> [dead-letter-policy](#input\_dead-letter-policy) | The dead letter policy for the subscription. | <pre>object({<br>    dead_letter_topic     = string<br>    max_delivery_attempts = number<br>  })</pre> | <pre>{<br>  "dead_letter_topic": null,<br>  "max_delivery_attempts": 3<br>}</pre> | no |

...
| <a name="input_selected_region"></a> [selected\_region](#input\_selected\_region) | List of uptime check region, minimum 3. Valid [USA (has 3 regions), EUROPE, SOUTH\_AMERICA, ASIA\_PACIFIC, USA\_OREGON, USA\_IOWA, USA\_VIRGINIA] | `list(string)` | `null` | no |

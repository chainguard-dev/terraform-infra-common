...
| <a name="input_region"></a> [region](#input\_region) | The region in which the GCS Bucket will be created if enabling dead letter queue to send messages to the GCS bucket. | `string` | n/a | yes |

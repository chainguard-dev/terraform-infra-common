...
resource "google_compute_url_map" "public-service" {
  ...
  // Recreating a google_compute_backend_service that references other dependent
  // resources like google_compute_url_map will give a
  ...
  // resources to avoid this type of error as shown in the Dynamic Backends example.
  lifecycle {

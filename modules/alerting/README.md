...
| <a name="input_notification_channels_incident_io"></a> [notification\_channels\_incident\_io](#input\_notification\_channels\_incident\_io) | Incident.io notification channel. | `list(string)` | `[]` | no |

...
| <a name="input_require_auth"></a> [require\_auth](#input\_require\_auth) | Whether to require authentication for the service, if ingress is not "INGRESS\_TRAFFIC\_INTERNAL\_ONLY". | `bool` | `false` | no |
